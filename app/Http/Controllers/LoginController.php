    ...
    public function auth(Request $request){                 
        ...
        try{
            ...
            if($response->getStatusCode() == 200){                   
                ...
                $branch_name    = $authObject->branch_name;
                ...
                $branchNameCookie   = Cookie::make('branch_name', $authObject->branch_name,      120, '/', ''.env('API_URL', NULL), false, true);
                ...
                return response()
                            ->json(compact('token', 'userName', 'userId', 'company', 'branch_office', 'country', 'userRole', 'branch_name'))
