<?php $__env->startSection('content'); ?>
    <div class="wrapper wrapper-content animated fadeInRight" ng-controller="WarehouseController as vm" ng-init="vm.readCompanyList(<?php echo e($_COOKIE['userRole']); ?>, <?php echo e($_COOKIE['company_id']); ?>, <?php echo e($_COOKIE['branch_office_id']); ?>)">
        <div class="row">
