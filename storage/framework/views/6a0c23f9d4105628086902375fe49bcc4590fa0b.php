    ...
    <div class="row wrapper border-bottom white-bg page-heading">
        <div class="col-lg-10">
            ...
            <ol class="breadcrumb">
                ...
                <li>
                    <a href="<?php echo e(url('/supplier')); ?>">Proveedores</a>
                </li>
                <li class="active">
    ...
    <div id="supplier" class="wrapper wrapper-content animated fadeInRight" ng-controller="SupplierController as vm">
            ...
            <div class="col-lg-12">
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5>Listaaaa de Proveedores</h5>
                        <div class="ibox-tools">                                                      
                            <a href="<?php echo e(url('/supplier/create')); ?>" class="btn btn-xs btn-primary"><span class="fa fa-plus-circle"></span> Nuevo0000000 Proveedor</a>
                        </div>
                    </div>                    
        ...
        <script>                                             
            ...
            $(document).ready( function () {
                ...
                var apiUrl =  '<?php echo e(env('API_HOST', NULL)); ?>/supplierDt/' + check; 
                $('#myTable').DataTable({
                    "processing" : false,
                    "serverSide" : true,
                    "language": {
                    ...
                    'columns'    : [
                        ...
                        },
                        {
                            ...
                            render: function (data){
                                let actions = '';
                                actions += '<center>'
                                         + '<a href="<?php echo e(url("supplier/edit")); ?>/'+data.id+'" class="btn btn-xs btn-default" style="margin-right:3px"><i class="fa fa-pencil"></i></a>'
