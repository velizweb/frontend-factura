<?php $__env->startSection('content'); ?>
    ...
    <div class="wrapper wrapper-content animated fadeInRight" ng-controller='SupplierController as vm' ng-init="vm.readCompanyList(<?php echo e($_COOKIE['userRole']); ?>, <?php echo e($_COOKIE['company_id']); ?>)">
        <div class="row">
            <div class="col-lg-12">
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5>Nuevo00 Proveedor</h5>
                        ...
                        <form class="form-horizontal" name="FrmSupplier" novalidate="novalidate" ng-submit="vm.create()">  
                            ...
                            <div class="form-group">
                                <div class="col-lg-offset-3 col-lg-6">
                                    ...
                                    <a class="btn btn-md btn-warning" href="<?php echo e(url('/supplier')); ?>">Volver</a>
                                </div>
                            </div>
