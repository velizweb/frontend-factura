                    ...
                    <div class="ibox-content">
                        ...
                        <form class="form-horizontal" name="FrmPlan" novalidate="novalidate" ng-submit="vm.create()">
                            ...
                            <div class="form-group"><label class="col-lg-2 col-lg-offset-1 control-label">Precio</label>
                             ...
                             <div class="form-group"><label class="col-lg-2 col-lg-offset-1 control-label">TESTER</label>
                                <div class="col-lg-6"><input id="tester" type="text" ng-model="vm.plan.tester" placeholder="TESTER" class="form-control" required>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <div class="col-lg-offset-3 col-lg-6">
                                    ...
                                    <a class="btn btn-md btn-warning" href="<?php echo e(url('/plan')); ?>">Volver</a>
                                </div>
                            </div>
