                ...
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <ul class="nav nav-tabs tabs-up" id="movements">
                            <li>
                              <a href="<?php echo e(env('API_HOST', NULL)); ?>/warehouseMov/1" data-target="#Entradas" data-table="1" class="media_node span" id="Entradas_tab" data-toggle="tabajax" rel="tooltip"><i class="fa fa-share" aria-hidden="true"></i> ENTRADAS </a>
                            </li>
                            <li>
                              <a href="<?php echo e(env('API_HOST', NULL)); ?>/warehouseMov/output" data-target="#Salidas" data-table="2" class="media_node span" id="Salida_tab" data-toggle="tabajax" rel="tooltip"><i class="fa fa-reply" aria-hidden="true"></i> SALIDAS </a>
                            </li>
                            <li>
                              <a href="<?php echo e(env('API_HOST', NULL)); ?>/warehouseMov/3" data-target="#Transferencias" data-table="3" class="media_node span" id="Transferencias_tab" data-toggle="tabajax" rel="tooltip"><i class="fa fa-exchange" aria-hidden="true"></i> TRANSFERENCIAS </a>
                            </li>
                            <li>
                              <a href="<?php echo e(env('API_HOST', NULL)); ?>/warehouseMov/7" data-target="#TransferenciasP" data-table="4" class="media_node span" id="TransferenciasP_tab" data-toggle="tabajax" rel="tooltip"><i class="fa fa-exchange" aria-hidden="true"></i> TRANSFERENCIAS PENDIENTES</a>
                            </li>
                        </ul>
                                        ...
                                        <table class="table table-striped table-bordered table-hover dataTables-example dataTable" id="myTableEntradas" aria-describedby="DataTables_Table_0_info" role="grid" >
                                            ...
                                            <thead>
                                                ...
                                                <tr role="row">
                                                    ...
                                                    <th class="sorting_asc" tabindex="0" rowspan="1" colspan="1" style="width: 20%;"><center>Proveedor</center></th>
                                        ...
                                        <table class="table table-striped table-bordered table-hover dataTables-example dataTable" id="myTableSalidas" aria-describedby="DataTables_Table_0_info" role="grid" >
                                            ...
                                            <thead>
                                                ...
                                                <tr role="row">
                                                    ...
                                                    <th class="sorting_asc" tabindex="0" rowspan="1" colspan="1" style="width: 20%;"><center>Tipo Salida</center></th>
