<?php $__env->startSection('content'); ?>
    ...
    <div ng-controller="InvoiceController as vm" ng-init="vm.loadCombos(<?php echo e($_COOKIE['company_id']); ?>, <?php echo e($_COOKIE['branch_office_id']); ?>);vm.company.id=<?php echo e($_COOKIE['company_id']); ?>">
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <select chosen
                                                                      ...
                                                                      ng-options="product.id as product.principal_code for product in vm.ProductList"
                            ...
                            <div class="row">
                                <div class="col-md-10 col-md-offset-1">
                                    <form class="horizontal" name="FrmClient" novalidate="novalidate" ng-submit="vm.createClient()">  
                                        <div class="form-group">
                                            <input class="form-control" type="hidden" ng-model="vm.company.id" ng-value="'<?php echo e(Cookie::get('company_id')); ?>'">                                        
                                        </div>
