<?php $__env->startSection('content'); ?>
    <div class="row wrapper border-bottom white-bg page-heading">
        <div class="col-lg-10">
            ...
            <ol class="breadcrumb">
                ...
                <li>
                    <a href="<?php echo e(url('/user')); ?>">Usuarios</a>
                </li>
                <li class="active">
    ...
    <div class="wrapper wrapper-content animated fadeInRight" ng-controller='UserController as vm' ng-init="vm.loadCompanies(<?php echo e($_COOKIE['userRole']); ?>, <?php echo e($_COOKIE['company_id']); ?>); vm.loadRole(<?php echo e($_COOKIE['userRole']); ?>, <?php echo e(env('ROLE_SUPERADMIN', NULL)); ?>);">
        <div class="row">
                        ...
                        <form class="form-horizontal" name="FrmUser" novalidate="novalidate" ng-submit="vm.create()">                            
                            ...
                            <div class="form-group">
                                <div class="col-lg-offset-3 col-lg-10">
                                    ...
                                    <a class="btn btn-md btn-warning" href="<?php echo e(url('/user')); ?>">Volver</a>
                                </div>
                            </div>
