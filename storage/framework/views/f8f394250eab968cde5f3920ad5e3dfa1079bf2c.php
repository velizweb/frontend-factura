<?php $__env->startSection('content'); ?>
    <div class="row wrapper border-bottom white-bg page-heading">
        <div class="col-lg-10">
            ...
            <ol class="breadcrumb">
                ...
                <li>
                    <a href="<?php echo e(url('/families')); ?>">Familia</a>
                </li>
                <li class="active">
                    <strong>Listar Familias</strong>
                </li>
            </ol>
        </div>
        <div class="col-lg-2">
    ...
    <div id="families" class="wrapper wrapper-content animated fadeInRight" ng-controller="FamiliesController as vm">
        <div class="row">
            <div class="col-lg-12">
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        ...
                        <div class="ibox-tools">
                            <a href="<?php echo e(url('/families/create')); ?>" class="btn btn-sm btn-primary"><span class="fa fa-plus-circle"></span> Crear Familia</a>                                                       
                        </div>
                    </div>                    
                    ...
                    <table class="table table-striped table-bordered table-hover dataTables-example dataTable" id="myTable" aria-describedby="DataTables_Table_0_info" role="grid" >
                        ...
                        <thead>
                            ...
                            <tr role="row">
                                ...
                                <th class="sorting_asc" tabindex="0" rowspan="1" colspan="1" style="width: 20%;"><center>Nombre Familia</center></th>
        ...
        <script>
            ...
            var apiUrl =  '<?php echo e(env('API_HOST', NULL)); ?>/familiesDt';         
                    ...
                    'columns'    : [
                        ...
                        },
                        {
                            ...
                            render: function (data){
                                let actions = '';
                                actions += '<center>'
                                         + '<a href="<?php echo e(url("families/edit")); ?>/'+data.id+'" class="btn btn-xs btn-default" style="margin-right:3px"><i class="fa fa-pencil"></i></a>'
            ...
            */
            function deleteElement(id){            
                angular.element(document.getElementById('families')).scope().vm.delete(id);
            }
