            ...
            <div class="col-lg-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <br>
                        <form class="form-horizontal" name="FrmProductEntry" novalidate="novalidate" ng-submit="vm.addEntryProduct(<?php echo e($_COOKIE['company_id']); ?>)">  
                            ...
                            <!--<div class="form-group">
                                ...
                                <div class="col-lg-4">
                                    <select chosen
                                          ...
                                          ng-change="vm.selectProduct(<?php echo e($_COOKIE['company_id']); ?>, vm.productSelected)">
                                          <option></option>
                                    </select>
                                </div>
                                <div class="col-lg-2">
