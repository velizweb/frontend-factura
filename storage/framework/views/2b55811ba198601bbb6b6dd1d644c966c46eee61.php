            ...
            <div class="col-lg-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <br>
                        <form class="form-horizontal" name="FrmProductOutput" novalidate="novalidate" ng-submit="vm.addOutputProduct(<?php echo e($_COOKIE['company_id']); ?>)">   
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-5">
                                    <select chosen
                                          ...
                                          ng-change="vm.selectOrigin(<?php echo e($_COOKIE['company_id']); ?>, <?php echo e($_COOKIE['branch_office_id']); ?>)" 
                                          required>
                                          <option></option>
                                    </select>
                                </div>
                            ...
                            <div class="form-group">
                                <div class="col-lg-offset-3 col-lg-9">
                                    ...
                                    <a class="btn btn-md btn-warning" href="<?php echo e(url('/branch')); ?>">Volver</a>
                                </div>
                            </div>
