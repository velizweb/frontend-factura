...
@section('content')
    ...
    <div id="families" class="wrapper wrapper-content animated fadeInRight" ng-controller="FamiliesController as vm">
                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        ...
                        <div class="ibox-tools">
                            <a href="{{url('/families/create')}}" class="btn btn-sm btn-primary"><span class="fa fa-plus-circle"></span> Crear Familia</a>                                                       
                        </div>
                    </div>                    
        ...
        <script>
            ...
            var apiUrl =  '{{env('API_HOST', NULL)}}/familiesDt';         
                    ...
                    'columns'    : [
                        ...
                        },
                        {
                            ...
                            render: function (data){
                                let actions = '';
                                actions += '<center>'
                                         + '<a href="{{url("families/edit")}}/'+data.id+'" class="btn btn-xs btn-default" style="margin-right:3px"><i class="fa fa-pencil"></i></a>'
