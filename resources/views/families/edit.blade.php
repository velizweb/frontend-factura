...
@section('content')
    <div class="wrapper wrapper-content animated fadeInRight" ng-controller="FamiliesController as vm" ng-init="vm.edit({{$id}})">
        <div class="row">
                ...
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        ...
                        <form class="form-horizontal" name="FrmFamilies" novalidate="novalidate" ng-submit="vm.update()">
                            <input type="hidden" ng-model="vm.families.id" value="{{$id}}" />
                            ...
                            <div class="form-group">
                                <div class="col-lg-offset-3 col-lg-6">
                                    ...
                                    <a class="btn btn-md btn-warning" href="{{url('/families')}}">Volver</a>
                                </div>
                            </div>
