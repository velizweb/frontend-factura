...
@section('content')
    <div class="wrapper wrapper-content animated fadeInRight" ng-controller="FamiliesController as vm" ng-init="vm.readCompanyList({{$_COOKIE['userRole']}}, {{$_COOKIE['company_id']}})">
        <div class="row">
