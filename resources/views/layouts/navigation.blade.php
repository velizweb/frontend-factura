         ...
         @endif
            ...
            <li>
                ...
                <ul class="nav nav-second-level collapse">
                    ...
                    <li><a href="{{ url('/warehouse/product_entry') }}">Entradas de Productos</a></li>
                    <li><a href="{{ url('/warehouse/createOutput')}}">Salidas de Productos</a></li>
                    <li><a href="{{ url('/warehouse/createTransfer')}}">Transferencias de Productos</a></li>
                    <li><a href="{{ url('/warehouse/searchTransfer')}}">Recepción de Transferencia</a></li>
                    <li><a href="{{ url('/warehouse/movements')}}">Movimientos</a></li>
                </ul>
            </li>
