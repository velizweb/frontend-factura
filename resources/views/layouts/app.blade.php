...
<head>
    ...
    <script src="{{ URL::asset('js/AppQuantum/services/app.families.services.js') }}"></script>
    ...
    <script src="{{ URL::asset('js/AppQuantum/controllers/app.families.controller.js') }}"></script>
