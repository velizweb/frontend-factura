            ...
            <div class="col-lg-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <br>
                        <form class="form-horizontal" name="FrmWareTransfer" novalidate="novalidate" ng-submit="vm.createTransfer({{$_COOKIE['company_id']}})">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-6">
                                    <select chosen
                                          ...
                                          ng-options="branch.name for branch in vm.BranchOfficesList track by branch.id"
                                          ng-change="vm.branchOfficeValidate({{$_COOKIE['userRole']}})">
                                          <option></option>
                                    </select>
                                </div>
                            </div>
