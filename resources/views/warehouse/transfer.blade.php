...
@section('content')
	...
	<div class="wrapper wrapper-content animated fadeInRight" ng-controller="WarehouseController as vm" ng-init="vm.readWarehouseList({{$_COOKIE['userRole']}}, {{$_COOKIE['company_id']}})">
        <div class="row">
            ...
            <div class="col-lg-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <br>
                        <form class="form-horizontal" name="FrmWareTransfer" novalidate="novalidate" ng-submit="vm.transfer()">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-6">                                
                                    <select chosen
                                    	...
                                    	ng-model="vm.warehouseOrigin"
                                    	ng-change="vm.selectOrigin(vm.warehouseOrigin, {{$_COOKIE['company_id']}})" 
                                    	required>
                                    	<option></option>
                                    </select>
                                </div>
	                                                ...
	                                                <table class="table table-responsive">
	                                                    ...
	                                                    <tbody>
	                                                        ...
	                                                        <tr>
	                                                            ...
	                                                            <td><input class="form-control centrarInput" type="text" ng-model="vm.Product.transferAmount"  value="0"></td>
	                                                            <td><button type="button" class="btn btn-md btn-success" ng-click="vm.addItemLine(vm.Product)" ng-disabled="!vm.ClientId>0"> <i class="fa fa-plus"></i></button></td>
	                                                        </tr>
	                                                    </tbody>
	                                                </table>
	                                            </div>                                   
